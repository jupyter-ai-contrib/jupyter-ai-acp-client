...
`JUPYTER_AI_ACP_CLIENT_E2E_TESTING_ONLY=1` disables the whole vendored set:
...
if os.environ.get("JUPYTER_AI_ACP_CLIENT_E2E_TESTING_ONLY") == "1":
    raise PersonaRequirementsUnmet(
        "Vendored ACP personas are disabled during E2E testing "
        "(JUPYTER_AI_ACP_CLIENT_E2E_TESTING_ONLY=1)."
    )
