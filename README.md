...
1. `@Claude-ACP`
   ...
   - optional env variable `CLAUDE_CODE_EXECUTABLE` points to your custom-installed Claud exectable location. By default, claude-code-acp uses Claude packaged in `@zed-industries/claude-code-acp`.
2. `@Kiro`
